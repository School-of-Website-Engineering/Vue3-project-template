            ...
            function t() {
                ...
                try {
                    (this.ns = 'CrispLoader'),
                        ...
                        (this.Ep = /(?:http\:|https\:)?\/\/[^\/]+\/l\/([a-zA-Z0-9\-_]+)\.js/i),
                        this.Sp(),
                        !0 === window[this.wp] ||
                            (void 0 !== window[this._p] && 'function' == typeof window[this._p].__init) ||
                            !0 !== this.Pp() ||
                            ((window[this.wp] = !0),
            ...
            return (
                            ...
                            (function t() {
                                s.Tp = setTimeout(function () {
                                    (s.Tp = null),
                                        ...
                                        !0 === n()
                                            ? (s.n.info(''.concat(s.ns, '.').concat(e), 'Dependencies loaded'),
                ...
                (i.Xp = function () {
                    try {
                        ...
                        (t.src = [''.concat(this.io, '/'), ''.concat(this.el, '/'), 'client.js?'.concat(this.x)].join(
                            '',
                        )),
                ...
                (i.Hp = function () {
                    (this.Op = !1),
                        ...
                        'string' == typeof CRISP_COOKIE_DOMAIN && CRISP_COOKIE_DOMAIN
                            ...
                            : (this.Ap = null),
                        'function' == typeof CRISP_READY_TRIGGER ? (this.Mp = CRISP_READY_TRIGGER) : (this.Mp = {}),
                        'object' == typeof CRISP_RUNTIME_CONFIG ? (this.Yp = CRISP_RUNTIME_CONFIG) : (this.Yp = {}),
                        'object' == typeof CRISP_INCLUDE_ATTRS ? (this.Zp = CRISP_INCLUDE_ATTRS) : (this.Zp = {});
                }),
                (i.$p = function () {
                    try {
                        (this.Up = []),
                ...
                (i.qp = function () {
                    ...
                    try {
                        this.Yp.locale &&
                            (-1 !== (t = this.Lp.indexOf(this.Yp.locale)) && this.Lp.splice(t, 1),
                ...
                (i.Qp = function () {
                    ...
                    try {
                        for (
                            var i,
                                n =
                                    0 < (null === (i = navigator.languages) || void 0 === i ? void 0 : i.length)
                                        ? navigator.languages
