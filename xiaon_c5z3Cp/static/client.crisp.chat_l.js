    ...
    try {
        new ((function () {
            ...
            return (
                ...
                (i.reset = function () {
                    try {
                        null !== this.Tp && clearTimeout(this.Tp),
                            this.Sp(),
                            this.init();
                    } catch (t) {}
                }),
                ...
                (i.Hp = function () {
                    (this.Op = !1),
                        ...
                        "string" == typeof CRISP_TOKEN_ID && CRISP_TOKEN_ID
                            ...
                            : "number" == typeof CRISP_TOKEN_ID &&
                              CRISP_TOKEN_ID
                            ? (this.Kp = CRISP_TOKEN_ID.toString())
                            : (this.Kp = null),
                        "number" == typeof CRISP_COOKIE_EXPIRE &&
                        0 < CRISP_COOKIE_EXPIRE
                            ? (this.Pi = CRISP_COOKIE_EXPIRE)
                            : (this.Pi = null),
                        "string" == typeof CRISP_COOKIE_DOMAIN &&
                        CRISP_COOKIE_DOMAIN
                ...
                (i.Jp = function (t) {
                    try {
                        for (var i in this.Zp)
                            this.Zp.hasOwnProperty(i) &&
                                t.setAttribute(i, this.Zp[i]);
                    } catch (t) {}
                }),
                (i.Vp = function () {
                    var t = null;
