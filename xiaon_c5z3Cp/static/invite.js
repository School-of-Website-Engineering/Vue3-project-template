...
function getinvite() {
    let mode = 'GET';
    let link = domain + 'https://ovc.xiaon.life/api/v1/user/invite/fetch';
    let params = '';
    tanjiazai();
...
function addinvitecode() {
    let mode = 'GET';
    let link = domain + 'https://ovc.xiaon.life/api/v1/user/invite/save';
    let params = '';
    tanjiazai();
...
function addhuazhuan() {
    let mode = 'POST';
    let link = domain + 'https://ovc.xiaon.life/api/v1/user/transfer';
    let a = document.getElementById('huazhuaninput');
    let params = {
...
function addtixian() {
    let mode = 'POST';
    let link = domain + 'https://ovc.xiaon.life/api/v1/user/ticket/withdraw';
