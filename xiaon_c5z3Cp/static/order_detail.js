...
function getdingdandetail(planid){
  let mode = 'GET';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/order/detail?trade_no='+planid;
  let params = '';
  tanjiazai();
...
function huoquzhifu(){
  let mode = 'GET';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/order/getPaymentMethod';
  let params = '';
  tanjiazai();
...
function cancelorder(ordernumber){
  let mode = 'POST';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/order/cancel';
...
function gotopay(){
  let mode = 'POST';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/order/checkout?trade_no='+tijiaocanshu['trade_no']+'&method='+tijiaocanshu['method'];
  let params = '';
  tanjiazai();
...
function checkstatus(){
  let mode = 'GET';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/order/check?trade_no='+trade_no_for_check;
  let params = '';
