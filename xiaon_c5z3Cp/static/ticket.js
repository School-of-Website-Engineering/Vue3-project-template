...
function getticket(){
  let mode = 'GET';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/ticket/fetch';
  let params = '';
  tanjiazai();
...
function closeticket(ticketid){
  let mode = 'POST';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/ticket/close';
  let params = {
    id : ticketid
  }
  console.log(params);
...
function detailticket(){
  let mode = 'GET';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/ticket/fetch?id='+ticketid_quanju;
  let params = '';
  console.log(params);
...
function sendmessage(ticketid){
  let mode = 'POST';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/ticket/reply';
...
function sendticket(){
  let mode = 'POST';
  let link = domain+'https://ovc.xiaon.life/api/v1/user/ticket/save';
