...
function getdingyue(planid) {
    let mode = 'GET';
    let link = domain + 'https://ovc.xiaon.life/api/v1/user/plan/fetch?id=' + planid;
    let params = '';
    tanjiazai();
...
function responsedingyue(code, data) {
    if (code == '200') {
        ...
        if (JSON.parse(data).data.half_year_price != null) {
            price_group['half_year_price'] = JSON.parse(data).data.half_year_price;
        }
        ...
        if (JSON.parse(data).data.two_year_price != null) {
            price_group['two_year_price'] = JSON.parse(data).data.two_year_price;
        }
        if (JSON.parse(data).data.three_year_price != null) {
            price_group['three_year_price'] = JSON.parse(data).data.three_year_price;
        }
